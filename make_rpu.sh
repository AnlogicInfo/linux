...
make ARCH=riscv CROSS_COMPILE=../toolchains/riscv/gcc/bin/riscv-nuclei-linux-gnu- anlogic_dr1v90_ccm_defconfig
make ARCH=riscv CROSS_COMPILE=../toolchains/riscv/gcc/bin/riscv-nuclei-linux-gnu- olddefconfig

#make dtbs
make ARCH=riscv CROSS_COMPILE=../toolchains/riscv/gcc/bin/riscv-nuclei-linux-gnu- dtbs

#Image
make ARCH=riscv CROSS_COMPILE=../toolchains/riscv/gcc/bin/riscv-nuclei-linux-gnu- Image -j8
