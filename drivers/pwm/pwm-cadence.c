...
#else
#define TTC_CLK_CNTRL_OFFSET		0x24
#define TTC_CNT_CNTRL_OFFSET		0x18
#define TTC_MATCH_CNT_VAL_OFFSET	0x48
#define TTC_COUNT_VAL_OFFSET		0x3C
#define TTC_INTR_VAL_OFFSET		0x30
#endif
