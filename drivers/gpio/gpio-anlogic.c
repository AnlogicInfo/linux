...
{
	struct dwapb_gpio_port *port;
	void __iomem *dat, *set, *clr, *dirout, *dirin;
	int err;
...
static const struct of_device_id dwapb_of_match[] = {
	{ .compatible = "snps,dw-apb-anlogic-gpio", .data = (void *)0},
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Anlogic, que");
MODULE_DESCRIPTION("Anlogic & Synopsys DesignWare APB GPIO driver");
